...
class IsiPelaporanWali extends StatefulWidget {
  final String laporanID;

  const IsiPelaporanWali({required this.laporanID, Key? key}) : super(key: key);

  @override
  _IsiPelaporanWaliScreenState createState() => _IsiPelaporanWaliScreenState();
}

class _IsiPelaporanWaliScreenState extends State<IsiPelaporanWali> {
