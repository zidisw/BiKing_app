...
class EditKartuWaliScreen extends StatefulWidget {
  static String routeName = 'EditKartuWaliScreen';
  ...
  final String initialPenanganan;

  const EditKartuWaliScreen({
    Key? key,
    ...
    required this.initialPenanganan,
  }) : super(key: key);
...
class _EditKartuScreenState extends State<EditKartuWaliScreen> {
  ...
  late TextEditingController penangananController;
  ...
  void initState() {
    ...
    penangananController = TextEditingController(text: widget.initialPenanganan);
  }
