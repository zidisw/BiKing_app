...
class IsiLaporanSiswaAdminScreen extends StatefulWidget {
  final String laporanID;

  const IsiLaporanSiswaAdminScreen({required this.laporanID, Key? key}) : super(key: key);

  @override
  _IsiLaporanSiswaAdminScreenState createState() => _IsiLaporanSiswaAdminScreenState();
}

class _IsiLaporanSiswaAdminScreenState extends State<IsiLaporanSiswaAdminScreen> {
