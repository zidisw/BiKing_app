...
class IsiPelaporanWaliAdminScreen extends StatefulWidget {
  final String laporanID;

  const IsiPelaporanWaliAdminScreen({required this.laporanID, Key? key}) : super(key: key);

  @override
  _IsiPelaporanWaliAdminScreenState createState() => _IsiPelaporanWaliAdminScreenState();
}

class _IsiPelaporanWaliAdminScreenState extends State<IsiPelaporanWaliAdminScreen> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder:
          ...
          final String penanganan = data['Penanganan'] as String? ?? '';
